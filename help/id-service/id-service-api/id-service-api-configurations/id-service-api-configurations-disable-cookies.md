...
When `disableThirdPartyCookies: true`, the ID service does not return the third-party, `demdex.net` cookie \(see [Cookies](id-service-api-configurations-cookies.md)\). 
