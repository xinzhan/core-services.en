...
See [Adobe Experience Cloud - Implementing Adobe Opt-Outs](https://experienceleague.adobe.com/docs/analytics/implementation/javascript-implementation/data-collection/opt-out.html?lang=en) for instructions. 
