...
|Daily frequency upload limitation| The best practic is to not update customer attributes more than once a day. Adobe recommends that you wait at least 24 hours to upload another customer profile data file (for the same set of profiles).|
